...
class StaticContractTest(unittest.TestCase):
    ...
    def test_static_asset_version_is_consistent(self):
        for name in ("index.html", "records.html", "record.html"):
            ...
            self.assertIn("styles.css?v=20260801-05", html)
            self.assertIn("ui-utils.js?v=20260801-05", html)
            self.assertIn("app-data.js?v=20260801-05", html)
            self.assertIn("firebase-client.js?v=20260801-05", html)
            if name == "index.html":
                self.assertIn("app-view.js?v=20260801-05", html)
                self.assertIn("app-date-picker.js?v=20260801-05", html)
                self.assertIn("app-backend.js?v=20260801-05", html)
        ...
        self.assertIn("const CACHE = 'customer-flow-note-v64';", service_worker)
        self.assertIn("const VERSION = '20260801-05';", service_worker)
