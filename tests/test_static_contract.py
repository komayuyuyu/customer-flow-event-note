...
class StaticContractTest(unittest.TestCase):
    ...
    def test_core_ui_contracts(self):
        ...
        self.assertIn(".site-nav { position: fixed; top: 0; right: 0; bottom: 0;", styles)
        self.assertIn(".menu-toggle { -webkit-appearance: none; appearance: none; display: flex;", styles)
        self.assertNotIn(".menu-toggle, .menu-header, .menu-close, .menu-overlay { display: none; }", styles)
