...
class SecurityContractTests(unittest.TestCase):
    ...
    def test_codeql_scans_javascript_on_main_and_pull_requests(self):
        ...
        self.assertIn("github/codeql-action/init@f205ea1c3313d32999d8d6a48b4f6530d4437b38 # v4", workflow)
        self.assertIn("github/codeql-action/analyze@f205ea1c3313d32999d8d6a48b4f6530d4437b38 # v4", workflow)
    ...
    def test_quality_checks_validate_code_and_data_without_write_permission(self):
        ...
        self.assertIn("actions/setup-node@249970729cb0ef3589644e2896645e5dc5ba9c38 # v6", workflow)
        self.assertNotRegex(workflow, r"uses: [^\n]+@v\d+")
        ...
        self.assertIn("python scripts/check_project_contracts.py", workflow)
