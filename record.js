...
function renderEdit() {
  ...
  const syncTimePlaceholders = () => document.querySelectorAll('.time-input-wrap input[type="time"]').forEach(input => input.closest('.time-input-wrap').classList.toggle('is-empty', !input.value));
